...
aligns with Go's idea of sharing memory by
...
In this example our state will be owned by a sigle
...
owning goroutine and receive coresponding replies.
These readOp and writeOp structs encapsulate those
requests and a way for the owning goroutine to response.
...
func main() {
	...
	*/
	...
	/*
		...
		and writes channels, responding to requests as they
		arrive. A response is executed by first performing the
		requested operation and then sending a vaue on the
	...
	*/
	...
	/*
		...
		state management example completes about 80,000 total
		operations.
		...
		approach feels most natural, especially with repect to
