...
useful string-related functions. Here are some examples to
give you a sense of the pacakge.
...
func main() {
	/*
		...
		question as the first argument to the function. You can
	...
	*/
	...
	/*
		...
		mechanisms for getting the length of a string in bytes and
		getting a byte by index.
	...
	*/
	...
	/*
		...
		you'll want to use encoding-aware operations. See strings,
		bytes, runes and characters in Go for morre information.
