...
Rate Limiting is an important mechamism for controlling
...
func main() {
	/*
		First we'll look at basic rate limiting. Support we want to
		limit our handling of incoming requests. We'll serve these requests off a channel of the same name
	*/
	...
	/*
		The limiter channel will receive a value very 200 milliseconds.
	...
	*/
	...
	/*
		...
		from the burst from the burst capability of burstyLimter.
	*/
