...
import (
	/*
		...
		the b64 name instead of the default base64. It'll save us
		some space below.
	*/
	b64 "encoding/base64"
	"fmt"
...
func main() {
	...
	/*
		...
		encoder requires a []byte so we cast our string to that
		type.
	*/
	...
	*/
	...
	/*
		This encode/decode using a URL-compatible base64
		format.
	*/
