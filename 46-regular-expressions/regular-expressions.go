...
func main() {
	...
	*/
	...
	/*
		This also finds the first match but returns the star and
	...
	*/
	...
	/*
		...
		the input, not just the first. For example to find all
	...
	*/
	...
	/*
		Providing a non-negative integer as the second argumant
	...
	*/
	...
	/*
		...
		names like MatchString. We can also provide []byte
		arguments and drop String from the function name.
	*/
	fmt.Println(r.Match([]byte("peach")))

	/*
		When creating constants with regular expressions you can
		use the MustCompile variation of Compile. A plain
		Compile won't work for constants because it has 2 return
		values.
	*/
