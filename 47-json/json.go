...
decoding, including to and from built-in and custom data
types
...
func main() {
	/*
		Fist we'll look at encoding basic data types to JSON
	...
	*/
	...
	/*
		...
		encoded output and will by default use those names as the
		JSON keys.
	*/
	res1D := &response1{
		Page:   1,
	...
	/*
		You can use tags in struct field declarations to customize
	...
	*/
	...
	/*
		...
		to cast them to their appropriate type. For example here
	...
	*/
	...
	/*
		...
		on standard out. We can also stream JSON encodings
		dirrectly to os.Writers like os.Stdout or even HTTP
		response bodies.
	*/
